        ...
        <div class="row d-flex align-items-center">
            <div class="col-lg-6">
                <figure class="about-image">
                    <img src="{{asset('assets/img/about-us.png')}}" alt="" class="wow fadeInUp" data-wow-delay="0.3s">
                </figure>
            </div>
            <div class="col-lg-6">
                <div class="about-text">
                    <h3 class="title wow fadeInUp" data-wow-delay="0.3s">About Us</h3>
                    <div class="sub-title wow fadeInUp" data-wow-delay="0.4s">
                        <p>Creative Media merupakan Digital Agency & IT Consultant Terpercaya</p>
                    </div>
